...
apt-get update
apt-get install -y git libmysqlclient-dev libsmi2ldbl snmp-mibs-downloader  libevent-dev libxslt1-dev libxml2-dev  python-mysqldb pkg-config libvirt-dev supervisor
